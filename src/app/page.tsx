...
export default function Page() {
    return (
        <div className="flex flex-col md:flex-row items-center md:justify-evenly md:items-stretch px-0 md:px-2">
            <header className="select-none md:sticky md:top-0 md:h-screen flex flex-col justify-between gap-6 w-11/12 md:w-5/12 2xl:w-1/3 min-w-min pt-10 md:pt-20 2xl:pt-24">
                <div className="flex flex-col justify-between gap-10">
                    <span className="text-nowrap">
                        <h1 className="text-4xl md:text-5xl font-bold">Mac Lee</h1>
